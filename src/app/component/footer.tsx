...
export default function Footer() {
  ...
  return (
    <main className="py-20 bg-black mt-8 pl-4 pr-4 md:flex md:space-x-12 2xl:pl-36 md:p-16">
      <div className="md:w-1/2">
        ...
        <div className=" text-white mt-2">
          ...
          Facebook, Shopify, etc
        </div>
      </div>
      <div className="group mt-4 pl-4 pr-4">
        <span className="text-xl text-white font-semibold group-hover:border-l-2 group-hover:border-red-600 pl-2">Company</span>
        {footerMenu.map((link)=>(
        <div className="text-slate-400 mt-4 pl-2 hover:text-white cursor-pointer" key={link.name}>
            {link.name}
        </div>
        ))}
      </div>
      <div className="group mt-4 pl-4 pr-4">
        <span className="text-xl text-white font-semibold group-hover:border-l-2 group-hover:border-red-600 pl-2">Support</span>
      ...
      <div className="group mt-4 pl-4 pr-4">
        <span className="text-xl text-white font-semibold group-hover:border-l-2 group-hover:border-red-600 pl-2">Follow us</span>
