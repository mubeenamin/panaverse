...
export default function MainSection() {
  return (
    <main>
      <div className="bg-white px-4 grid md:grid-cols-2 space-y-8 md:justify-between md:items-center md:max-w-[1240px] md:mx-auto md:space-y-0 md:py-20 md:space-x-14 ">
        <div>
